...
class Courses(models.Model):
    ...
    teachers = models.ForeignKey(Teachers, on_delete=models.CASCADE, verbose_name='Преподаватель')
    students = models.ForeignKey(Students, on_delete=models.PROTECT, verbose_name='Студент')
    methods = models.TextField(verbose_name='Методика обучения')
    questions = models.TextField(verbose_name='Часто задаваемые вопросы')
